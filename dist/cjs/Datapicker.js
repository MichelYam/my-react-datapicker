...
const Datapicker = ({ selectedDate, setSelectedDate, customHeader, dataFormat, inputId }) => {
    ...
    return (react_1.default.createElement("div", { className: 'datapicker' },
        react_1.default.createElement("div", { className: 'datapicker-input', onClick: () => setIsOpen(true) },
            react_1.default.createElement(input_1.default, { inputId: inputId, selectedDate: selectedDate, setSelectedDate: setSelectedDate, dataFormat: dataFormat, datapickerRef: datapickerRef }),
