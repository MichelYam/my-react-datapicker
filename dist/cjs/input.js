...
const Index = ({ selectedDate, dataFormat, setSelectedDate, datapickerRef, inputId }) => {
    return (react_1.default.createElement("input", { id: inputId, type: 'text', ref: datapickerRef, placeholder: dataFormat ? dataFormat : 'DD/MM/AAAA', value: selectedDate, onChange: (e) => setSelectedDate(e.target.value) }));
};
