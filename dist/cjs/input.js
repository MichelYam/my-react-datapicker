...
const Index = ({ selectedDate, dataFormat, setSelectedDate }) => {
    return (react_1.default.createElement("input", { id: 'data', type: 'text', placeholder: dataFormat ? dataFormat : 'DD/MM/AAAA', value: selectedDate, onChange: (e) => setSelectedDate(e.target.value) }));
};
