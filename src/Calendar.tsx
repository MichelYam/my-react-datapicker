...
const Index = ({ customHeader, setSelectedDate, selectedDate, dataFormat, setIsOpen, isOpen, datapickerRef }: props) => {
  ...
  const checkDaySelected = (daySelected: test) => {
    ...
    dataFormat === "MM/DD/YYYY" ?
      setSelectedDate(`${month}/${daySelected.day}/${year}`) : setSelectedDate(`${daySelected.day}/${month}/${year}`)
    setIsOpen(false)
  }
  ...
  return (
    <div className={`datapicker-calendar ${isOpen ? "show" : "hidden"}`} >
